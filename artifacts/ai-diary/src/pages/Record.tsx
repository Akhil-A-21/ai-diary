  ...
  if (stage === "done" && analysis) {
    return (
      <div className="max-w-lg mx-auto py-10 space-y-6 text-center">
        ...
        <div className="rounded-2xl border p-5 text-left space-y-3"
          ...
          {analysis.summary && (
            <p className="text-sm leading-relaxed border-t pt-3"
              style={{ borderColor: "hsl(240 12% 20%)", color: "hsl(240 8% 70%)" }}>
              {analysis.summary}
            </p>
          )}
        </div>
    ...
    return (
      <div className="max-w-lg mx-auto flex flex-col items-center justify-center py-24 space-y-5">
        ...
        <p className="text-lg font-semibold">
          {stage === "uploading" ? "Saving your entry…" : "Aura is listening…"}
        </p>
        <p className="text-sm" style={{ color: "hsl(240 8% 55%)" }}>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative rounded-2xl overflow-hidden w-full"
        ...
        {/* Live camera feed — always mounted so srcObject assignment works */}
        <video
          ref={liveVideoRef}
        ...
        {/* ── Prompt overlay (top of live video) ── */}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[10px] font-semibold uppercase tracking-widest mb-1"
                style={{ color: "#f59e0b" }}>Today's Prompt</p>
      ...
      {stage === "error" && (
        <div className="flex items-center gap-3 p-4 rounded-xl border"
          ...
          <button onClick={reRecord} className="text-sm font-medium"
